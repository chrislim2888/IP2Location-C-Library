...
# language = "en"
myst_html_meta = {
    "description": "IP2Location C library enables user to query the geolocation information for an IP address.",
    "keywords": "IP2Location, Geolocation, IP location, C",
